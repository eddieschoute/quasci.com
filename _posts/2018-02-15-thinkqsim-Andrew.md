...
[^1]: See, for example, the talks by Andrew Childs and Garnet Chan.
...
[^4]: More specifically, the k-local Hamiltonian simulation problem has been shown to be QMA-complete for $k \ge 2$. See the following paper for details: Kempe, J., Kitaev, A., & Regev, O., _The complexity of the local Hamiltonian problem_, SIAM Journal on Computing, 35 (5): 1070–1097. (2006) {% include doi.html doi='10.1137/S0097539704445226' %}
...
[^qma]: In general, state preparation is QMA-hard. 
